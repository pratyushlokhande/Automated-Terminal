...
while (y=='true'):
    ...
    if ('close' in p):
        ...
        if ('dont' in p):
            ...
            if (('launch' in p) or ('execute' in p) or ('run' in p) or ('open' in p) or ('change' in p) or ('calander' in p) or ('calculator' in p)):
                if('chrome' in p):
                    ...
                    print_slow('Opening Calculator...\n');
                    os.system('calc');
                elif ('calender' in p):
                    print_slow('Opening Calander...\n');
                    os.system('cal');
                else:
